...
import (
	...
	"github.com/falola13/go-ecommerce/models"
...
func EditHomeAddress() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		ctx.Done()
		c.IndentedJSON(200, gin.H{"message": "Successfully updated the home address", "home_address": editaddress})
...
func EditWorkAddress() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		ctx.Done()
		c.IndentedJSON(200, gin.H{"message": "Successfully updated the work address", "work_address": editaddress})
	}
}
...
func DeleteAddress() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		ctx.Done()
		c.IndentedJSON(200, gin.H{"message": "Successfully deleted address"})
	}
}
