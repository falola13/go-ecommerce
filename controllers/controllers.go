...
func Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "Login credentials are incorrect"})
			return
		}
...
func SearchProductByQuery() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		c.IndentedJSON(200, gin.H{"message": "Successfully searched product", "count": len(searchProducts), "product": searchProducts})
	}
}
